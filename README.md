...
Execution graph scheduling uses early-continue to simplify execute-path traversal (details in `NOTES-AI.md`).
...
Function validation invariants are tracked in `NOTES-AI.md`.

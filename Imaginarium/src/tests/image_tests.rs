...
fn it_works() {
    ...
    assert_eq!(tiff.color_format.channel_size, ChannelSize::_32bit);
    assert_eq!(tiff.color_format.channel_count, ChannelCount::Rgb);
    ...
    assert_eq!(png.color_format.channel_size, ChannelSize::_8bit);
    assert_eq!(png.color_format.channel_count, ChannelCount::Rgba);
    ...
    assert_eq!(png.color_format.channel_size, ChannelSize::_8bit);
    assert_eq!(png.color_format.channel_count, ChannelCount::Rgb);
}

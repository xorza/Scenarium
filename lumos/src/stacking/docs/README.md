...
| 1 | Load-time clamp to `[0,1]` can positively bias dark/bias **masters**; CFA/Bayer-drizzle pieces exist but are unwired. | `src/io/raw/mod.rs`, `src/io/image/fits/mod.rs` |

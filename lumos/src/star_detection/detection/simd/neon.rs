...
pub unsafe fn create_threshold_mask_neon(
    ...
    while i < unrolled_end {
        ...
        let bg0 = vld1q_f32(bg_ptr.add(i));
        let bg1 = vld1q_f32(bg_ptr.add(i + 4));
        let bg2 = vld1q_f32(bg_ptr.add(i + 8));
        let bg3 = vld1q_f32(bg_ptr.add(i + 12));
    ...
    while i + NEON_WIDTH <= len {
        ...
        let bg_vec = vld1q_f32(bg_ptr.add(i));
...
pub unsafe fn create_threshold_mask_filtered_neon(
    ...
    while i < unrolled_end {
        // Load 4 vectors worth of data
        let px0 = vld1q_f32(filtered_ptr.add(i));
        let px1 = vld1q_f32(filtered_ptr.add(i + 4));
        let px2 = vld1q_f32(filtered_ptr.add(i + 8));
        let px3 = vld1q_f32(filtered_ptr.add(i + 12));
        ...
        let thresh0 = vmulq_f32(sigma_vec, vmaxq_f32(noise0, min_noise_vec));
        let thresh1 = vmulq_f32(sigma_vec, vmaxq_f32(noise1, min_noise_vec));
        let thresh2 = vmulq_f32(sigma_vec, vmaxq_f32(noise2, min_noise_vec));
        let thresh3 = vmulq_f32(sigma_vec, vmaxq_f32(noise3, min_noise_vec));
    ...
    // Process remaining full NEON vectors (0-3 vectors)
    while i + NEON_WIDTH <= len {
        let px_vec = vld1q_f32(filtered_ptr.add(i));
        let noise_vec = vld1q_f32(noise_ptr.add(i));

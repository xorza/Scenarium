...
bindings, event subscriptions, pinned outputs, and local graphinitions.
...
values. A `NodeAddress` contains the graph-instance path plus the definition
...
| `graph/graph.rs` | Composite definitions and references |

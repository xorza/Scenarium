...
impl Bezier {
    ...
    pub fn sample(points: &mut Vec<Pos2>, p0: Pos2, p1: Pos2, p2: Pos2, p3: Pos2) {
    ...
    pub fn segments_intersect(a1: Pos2, a2: Pos2, b1: Pos2, b2: Pos2) -> bool {
        let o1 = Self::orient(a1, a2, b1);
        let o2 = Self::orient(a1, a2, b2);
        let o3 = Self::orient(b1, b2, a1);
        let o4 = Self::orient(b1, b2, a2);
        let eps = 1e-6;

        if o1.abs() < eps && Self::on_segment(a1, a2, b1) {
            return true;
        }
        if o2.abs() < eps && Self::on_segment(a1, a2, b2) {
            return true;
        }
        if o3.abs() < eps && Self::on_segment(b1, b2, a1) {
            return true;
        }
        if o4.abs() < eps && Self::on_segment(b1, b2, a2) {
            return true;
        }
